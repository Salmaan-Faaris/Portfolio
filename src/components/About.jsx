...
import {
    FiCode, FiDatabase, FiCloud, FiTool,
    FiBookOpen, FiTarget,
} from 'react-icons/fi';
import {
    SiPython, SiJavascript, SiReact, SiNodedotjs,
    SiTensorflow, SiPytorch, SiOpencv, SiMongodb,
    SiMysql, SiGit, SiFigma, SiFlask, SiGooglecloud,
} from 'react-icons/si';
...
const education = [
    {
        ...
        details: 'GPA: 7.93/10 (till 6th semester) • Coursework: ML, DL, Data Science, Computer Vision, NLP, Cloud Computing',
    },
    {
        period: '2020 — 2022',
...
export default function About() {
    return (
        <section id="about" style={{ background: 'var(--bg-surface)', position: 'relative' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                            {education.map((edu, i) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <h4 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: 4 }}>
                                            {edu.title}
                                        </h4>
                    ...
                    <div style={{ marginBottom: 60 }}>
                        ...
                        <div style={{
                            ...
                            {toolIcons.map((tool) => (
                                ...
                                >
                                    {tool.icon}
                                    <span style={{ fontSize: '0.7rem', fontWeight: 500 }}>{tool.label}</span>
                                </motion.div>
                            ))}
                        </div>
                    </div>
                ...
                <ScrollReveal delay={0.4}>
                    <div style={{
                        ...
                        <p style={{
                            ...
                            My goal is to contribute meaningfully to research and industry projects while constantly
                            learning and growing in the field of technology. I am eager to explore cutting-edge
                            technologies and apply them to solve real-world problems, particularly in the domains of
                            Computer Vision, NLP, and AI-driven applications.
                        </p>
                        <div style={{
                            position: 'absolute',
                            top: -20,
